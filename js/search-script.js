/*!å
 * Simple-Jekyll-Search v1.7.8 (https://github.com/christian-fei/Simple-Jekyll-Search)å
 * Copyright 2015-2020, Christian Feiå
 * Licensed under the MIT License.å
 */
!(function () {
  "use strict";
  var i = {
  ...
  function g(t) {
    u.put(t),
      m.searchInput.addEventListener("keyup", function (t) {
    ...
    (y = function (t) {
      ...
      return (
        0 < w.validate(t).length &&
          j("You must specify the following required options: " + v),
        (m = h.merge(m, t)),
        i.setOptions({
